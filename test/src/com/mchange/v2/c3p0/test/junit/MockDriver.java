...
public class MockDriver implements Driver {
  ...
  public boolean acceptsURL(String url) throws SQLException {
    ...
    // theoretical -- it hung C3P0TestInternalsJUnitTestCase, whose fake driver's URLs this one was
    // answering, with a Connection whose prepareStatement(...) returns null.
    if (url == null) {
      return false;
    }
