...
public class SimplePropertyBeanGenerator implements PropertyBeanGenerator
{
    ...
    {
	iw.print( BeangenUtils.getModifierString( prop.getVariableModifiers() ) );
	...
	iw.print( BeangenUtils.getModifierString( prop.getGetterModifiers() ) );
    ...
    {
	iw.print( BeangenUtils.getModifierString( prop.getSetterModifiers() ) );
    ...
    {
	iw.print( BeangenUtils.getModifierString( info.getModifiers() ) + " class " + info.getClassName() );
