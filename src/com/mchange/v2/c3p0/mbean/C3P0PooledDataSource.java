...
public class C3P0PooledDataSource implements C3P0PooledDataSourceMBean
{
    ...
    public void setTaskRunnerFactoryClassName( String taskRunnerFactory ) throws PropertyVetoException, NamingException
    {
	combods.setTaskRunnerFactoryClassName( taskRunnerFactory );
	rebind();
    }
